  ...
  <ul class="cards">
    <li class="cards_item">
      <div class="card">
        ...
        <div class="card_content">
          <h2 class="card_title">Farmstand Salad &#x2022; <d class="price">$9 </d></h2>
    ...
    <li class="cards_item">
      <div class="card">
        ...
        <div class="card_content">
          <h2 class="card_title">Ultimate Reuben &#x2022; <d class="price"> $18</d></h2>
          <div class="card_text">
    ...
    <li class="cards_item">
      <div class="card">
        ...
        <div class="card_content">
          <h2 class="card_title">Fig &amp; Berry Plate &#x2022;  <d class="price">$16</d></h2>
          <div class="card_text">
